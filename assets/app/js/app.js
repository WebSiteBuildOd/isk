                ...
                return (
                    (modules = [
                        ...
                        function (t, e, i) {
                            ...
                            s.default.extendDefinitions({ A: { validator: "[A-Za-zА-яЁёÀ-ÿµ]", casing: "upper" }, "&": { validator: "[0-9A-Za-zА-яЁёÀ-ÿµ]", casing: "upper" }, "#": { validator: "[0-9A-Fa-f]", casing: "upper" } });
                        ...
                        function (t, e, i) {
                            ...
                            function h(t, e, i, n, s) {
                                var a = e.buffer ? e.buffer.indexOf(s.radixPoint) : -1,
                                    r = -1 !== a && new RegExp("[0-9１-９]").test(t);
